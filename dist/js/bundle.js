...
function calc() {
  ...
  for (var i = 0; i < inputConter.length; i++) {
    inputConter[i].addEventListener('input', function (event) {
      if (/\d/.test(event.target.value)) {} else {
        event.target.value = '';
      }
...
function form() {
  ...
  for (var i = 0; i < inputFormNumber.length; i++) {
...
window.addEventListener('DOMContentLoaded', function () {
  var form = __webpack_require__(/*! ./form */ "./js/form.js");

  var slider = __webpack_require__(/*! ./slider */ "./js/slider.js");

  var modal = __webpack_require__(/*! ./modal */ "./js/modal.js");

  var timer = __webpack_require__(/*! ./timer */ "./js/timer.js");

  var calc = __webpack_require__(/*! ./calc */ "./js/calc.js");

  var tabs = __webpack_require__(/*! ./tabs */ "./js/tabs.js");
